...
<div id="fd_credit_card_info" class="uk-padding">
    ...
    <ul class="info--lists">
        ...
        <li>
            Each month, you'll receive a statement that shows your balance, transactions, and minimum payment due.
        </li>
        <li>
            Interest is charged on any outstanding balance, so it's important to pay off as much as you can each month.
        </li>
        <li>
            Some credit cards charge additional fees, such as an annual fee or foreign transaction fee.
        </li>
        <li>
            There are different types of credit cards available, such as balance transfer cards and rewards cards.
        </li>
        <li>
            When choosing a credit card, consider the interest rate, fees, and any additional benefits or rewards.
        </li>
        <li>
            Your credit score will impact your eligibility for certain cards and the interest rate you're offered.
        </li>
        <li>
            It's important to use credit cards responsibly and only borrow what you can afford to repay to avoid negative impacts on your credit score and financial difficulties.
        </li>
    </ul>
</div>
...
<div>
    <ul uk-accordion="multiple: true">
        <li>
            <a class="uk-accordion-title fd--accordian--title" href="#">What types of credit cards are available?</a>
            <div class="uk-accordion-content uk-padding-small">
                ...
                <ul class="info--lists">
                    ...
                    <li>
                        Rewards credit cards: With a rewards credit card, you earn rewards points or cashback for your purchases. These rewards can be redeemed for travel, merchandise, or other rewards.
                    </li>
                    <li>
                        Cashback credit cards: With a cashback credit card, you earn cashback on your purchases. This can be a good option if you want to earn rewards that can be used for anything, rather than specific rewards like travel or merchandise.
                    </li>
                    <li>
                        Low-interest credit cards: With a low-interest credit card, you pay a lower interest rate on your balance than with a standard credit card. This can be a good option if you carry a balance on your credit card and want to save money on interest.
                    </li>
                    <li>
                        Premium credit cards: Premium credit cards offer additional perks and benefits, such as travel insurance, airport lounge access, and concierge services. These cards typically have higher fees and stricter eligibility requirements.
                    </li>
                    <li>
                        Credit builder credit cards: Credit builder credit cards are designed for people with limited credit history or poor credit. These cards typically have higher interest rates and lower credit limits, but can help you build or improve your credit score over time.
                    </li>
                </ul>
                <p>
                    When choosing a credit card, it's important to consider your spending habits, your financial goals, and your credit score. You should also compare rates and features from different credit card issuers to find the best card for your needs.
                </p>
            </div>
        </li>
    </ul>
