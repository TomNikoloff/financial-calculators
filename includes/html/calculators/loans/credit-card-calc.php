...
<ul class="uk-breadcrumb">
    ...
    -->
    <li><a href="#" onclick="_CORE.funcs.handleBreadcrumbs('loans')">Credit / Loans</a></li>
        ...
        <div class="uk-card-body">
            <div class="">
                ...
                <div class="uk-margin-medium uk-position-relative">
                    ...
                    <input data-calculator-field="CREDIT-CARD-CALC-interest-rate" type="range" min="0.25" max="40" value="19.25" step="0.25" class="styled-slider slider-progress">
