            ...
            <div>
                ...
                <div class="uk-margin-medium uk-position-relative">
                    ...
                    <h4 class="uk-flex uk-flex-center uk-margin-remove">
                        <span id="SIMPLE-MORTGAGE-CALC_repayment_interest_rate_text" class="uk-text-bold">4.25</span> %
                    </h4>
                    <input id="SIMPLE-MORTGAGE-CALC_repayment_interest_rate" type="range" min="0.25" max="15" value="4.25" step="0.25" class="styled-slider slider-progress" oninput="_CORE.simple_mortgage.funcs.updateSlider(this)">
                ...
                <div class="uk-position-relative">
                    <h2 class="uk-text-center" data-results-suffix="a month">This will cost <span id="SIMPLE-MORTGAGE-CALC_repayment_monthly_result" class="uk-text-bold">£602.38</span></h2>
                </div>
            </div>
        </div>
    </div>
