	...
	c.extend(	
	{
		...
		funcs:{
			...
			setupInputs: function() {
				...
				_CORE.utils.blurOnKeyPress(_CORE.refs["SIMPLE-SAVINGS-CALC-savings-balance"]);
				...
				_CORE.utils.blurOnKeyPress(_CORE.refs["SIMPLE-SAVINGS-CALC-monthly-savings"]);
				...
				_CORE.utils.blurOnKeyPress(_CORE.refs["SIMPLE-SAVINGS-CALC_savings-term-years"]);
				...
				_CORE.utils.blurOnKeyPress(_CORE.refs["SIMPLE-SAVINGS-CALC_savings-term-months"]);
				...
				_CORE.utils.blurOnKeyPress(_CORE.refs["SIMPLE-SAVINGS-CALC-interest-rate-text"]);

				_CORE.refs["SIMPLE-SAVINGS-CALC-interest-rate"].value = '3';

				_CORE.refs["SIMPLE-SAVINGS-CALC-interest-rate"].addEventListener("input", function(){
